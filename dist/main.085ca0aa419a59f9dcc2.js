...
}`, "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA;EACE,uBAAA;AACF","sourcesContent":["body {\r\n  background-color: beige;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
var ___HTML_LOADER_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./index.js */ "./src/index.js?0bf1"), __webpack_require__.b);
// Module
var ___HTML_LOADER_REPLACEMENT_0___ = _node_modules_html_loader_dist_runtime_getUrl_js__WEBPACK_IMPORTED_MODULE_0___default()(___HTML_LOADER_IMPORT_0___);
var code = "<!DOCTYPE html>\n<html lang=\"en\">\n\n<head>\n    <meta charset=\"UTF-8\">\n    <title>WebPack Test</title>\n</head>\n\n<body>\n    <header>\n        <h1>WebPack</h1>\n    </header>\n    <main>\n        <button class=\"btn-get-json\" type=\"submit\">Get POSTS</button>\n        <div class=\"json-info\"></div>\n    </main>\n    <" + "script src=\"" + ___HTML_LOADER_REPLACEMENT_0___ + "\"><" + "/script>\n</body>\n\n</html>";
// Exports
...
module.exports = __webpack_require__.p + "e139a72c6cb2c0a6246a.js";
...
buttonGet.addEventListener("click", () => {
  ...
  fetch("http://127.0.0.1:3000/posts/", options).then(response => response.json()).then(json => putPostIntoHTML(json)).catch(error => {
    console.log(error);
  });
});
function putPostIntoHTML(json) {
  let innerHTML = "<table class='table'>" + "<thead>" + "<td>Author</td>" + "<td>Title</td>" + "</thead>";
...
/******/ })()
;
//# sourceMappingURL=main.085ca0aa419a59f9dcc2.js.map